...
<h3>支出一覧</h3>
  ...
  <tr><th>日付<?php echo $this->Paginator->sort('Expenditure.date', '▼', array('url' => array($year_id, $month_id))); ?></th>
      ...
      <th class="tbl-ico">種類<?php echo $this->Paginator->sort('Expenditure.genre_id', '▼', array('url' => array($year_id, $month_id))); ?></th>
